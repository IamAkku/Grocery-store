              ...
              <div className="card mb-10">
                ...
                <a href="#!">
                    ...
                    <div className="product-seller-recommended">
                      <div className="product-description mb-5">
                        ...
                        <dl className="row mb-5">
                          <dt className="col-sm-3">Shopkeeper</dt>
                          <dd className="col-sm-9">General Kirana Store</dd>
                          <dt className="col-sm-3">Color</dt>
                          <dd className="col-sm-9">Pink</dd>
                          <dt className="col-sm-3">Rate</dt>
                          <dd className="col-sm-9">₹100/kg</dd>
                          <dt className="col-sm-3">Category</dt>
                          <dd className="col-sm-9">Vegetable</dd>
                        </dl>
                  ...
                  <div className="product-payment-details">
                    ...
                    <p className="text-success"><i className="fa fa-credit-card"></i> No EMI</p>
                    <p className="mb-0"><i className="fa fa-truck"></i> 2-day delivery anywhere in India</p>
