    ...
    <div className="col-lg-8">
            ...
            <div className="col-md-7 col-lg-9 col-xl-9">
              <div>
                <div className="d-flex justify-content-between">
                  <div>
                    <h5>Vegetable</h5>
                    <p className="mb-3 text-muted text-uppercase small">Carrot</p>
                    <p className="mb-2 text-muted text-uppercase small">Color: Orange</p>
                    <p className="mb-3 text-muted text-uppercase small">Rate: 100/Bag</p>
                    <p className="mb-3 text-muted text-uppercase small">Quantity: 20Pcs/Bag</p>
                  </div>
                </div>
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  <p className="mb-0"><span><strong>₹100/-</strong></span></p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="col-md-7 col-lg-9 col-xl-9">
              <div>
                <div className="d-flex justify-content-between">
                  <div>
                    <h5>Vegetable</h5>
                    <p className="mb-3 text-muted text-uppercase small">Onion</p>
                    <p className="mb-2 text-muted text-uppercase small">Color: Pink</p>
                    <p className="mb-3 text-muted text-uppercase small">Rate: 120/kg</p>
                    <p className="mb-3 text-muted text-uppercase small">Quantity: 1kg</p>
                  </div>
      ...
      <div className="card mb-3">
        <div className="card-body">
          ...
          <p className="mb-0"> Thu., 24.03. - Mon., 30.03.</p>
        </div>
      </div>
